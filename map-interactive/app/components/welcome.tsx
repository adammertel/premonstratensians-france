...
export const Welcome: React.FC<WelcomeProps> = ({ store }) => {
  const dateOptions = {
    year: "numeric",
    month: "long",
    day: "numeric",
      ...
      <div className="content ">
        ...
        <div className="px-6 py-4">
          <p>
            ...
            available, edited by Bernard Ardura{" "}
            <span className="text-italic">
              (Abbayes, prieurés et monastères de l’ordre de Prémontré en France
              des origines à nos jours: Dictionnaire historique et
              bibliographique, 1993)
            </span>
          </p>
          <div className="py-4">
            ...
            <ul className="list-disc">
              ...
              <li className="ml-8">
                <span className="text-bold">filtering</span> by time, gender of
                the community (male, female, double monastery), and status
                (abbey or priory);
              </li>
              <li className="ml-8">
                <span className="text-bold">a choice of base maps</span>,
                including the Cassini map;
              </li>
              <li className="ml-8">
                <span className="text-bold">an info box</span> under each object
                showing the ID number of the record, place name, the earliest
                and latest possible dates for both foundation and dissolution,
                certainty of localisation, dedication, and a link to a Wikipedia
                entry (if available).
              </li>
            </ul>
          </div>
          <div className="py-4">
            <ul>
              ...
              <li>
                ...
                <span>
                  Digitized and geocoded by Jaroslava Fabíková under the
                  supervision of David Zbíral.
                </span>
              </li>
              <li>
                <span>
